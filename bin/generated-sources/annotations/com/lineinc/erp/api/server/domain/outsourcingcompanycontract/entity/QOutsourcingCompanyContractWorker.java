...
public class QOutsourcingCompanyContractWorker extends EntityPathBase<OutsourcingCompanyContractWorker> {
    ...
    private static final long serialVersionUID = -1787204644L;
    ...
    public final ListPath<OutsourcingCompanyContractWorkerFile, QOutsourcingCompanyContractWorkerFile> files = this.<OutsourcingCompanyContractWorkerFile, QOutsourcingCompanyContractWorkerFile>createList("files", OutsourcingCompanyContractWorkerFile.class, QOutsourcingCompanyContractWorkerFile.class, PathInits.DIRECT2);
