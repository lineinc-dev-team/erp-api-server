...
public class QSiteChangeHistory extends EntityPathBase<SiteChangeHistory> {
    ...
    public final EnumPath<com.lineinc.erp.api.server.domain.site.enums.SiteChangeHistoryType> type = createEnum("type", com.lineinc.erp.api.server.domain.site.enums.SiteChangeHistoryType.class);
