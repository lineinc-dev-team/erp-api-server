...
public class QClientCompanyChangeHistory extends EntityPathBase<ClientCompanyChangeHistory> {
    ...
    private static final long serialVersionUID = 185874482L;
    ...
    public final EnumPath<com.lineinc.erp.api.server.domain.clientcompany.enums.ClientCompanyChangeHistoryChangeType> type = createEnum("type", com.lineinc.erp.api.server.domain.clientcompany.enums.ClientCompanyChangeHistoryChangeType.class);
