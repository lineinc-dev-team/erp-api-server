...
public class QMaterialManagement extends EntityPathBase<MaterialManagement> {
    ...
    public final ListPath<MaterialManagementChangeHistory, QMaterialManagementChangeHistory> changeHistories = this.<MaterialManagementChangeHistory, QMaterialManagementChangeHistory>createList("changeHistories", MaterialManagementChangeHistory.class, QMaterialManagementChangeHistory.class, PathInits.DIRECT2);
