...
public class QClientCompany extends EntityPathBase<ClientCompany> {
    ...
    private static final long serialVersionUID = 2040261554L;
    ...
    public final StringPath homepageLoginId = createString("homepageLoginId");

    public final StringPath homepagePassword = createString("homepagePassword");
    ...
    public final EnumPath<com.lineinc.erp.api.server.domain.clientcompany.enums.ClientCompanyPaymentMethod> paymentMethod = createEnum("paymentMethod", com.lineinc.erp.api.server.domain.clientcompany.enums.ClientCompanyPaymentMethod.class);
