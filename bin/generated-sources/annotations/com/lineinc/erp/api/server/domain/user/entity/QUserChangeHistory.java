...
public class QUserChangeHistory extends EntityPathBase<UserChangeHistory> {
    ...
    public final EnumPath<com.lineinc.erp.api.server.domain.user.enums.UserChangeHistoryType> type = createEnum("type", com.lineinc.erp.api.server.domain.user.enums.UserChangeHistoryType.class);
    ...
    public final QUser updatedByUser;
    ...
    public QUserChangeHistory(Class<? extends UserChangeHistory> type, PathMetadata metadata, PathInits inits) {
        ...
        this.updatedByUser = inits.isInitialized("updatedByUser") ? new QUser(forProperty("updatedByUser"), inits.get("updatedByUser")) : null;
