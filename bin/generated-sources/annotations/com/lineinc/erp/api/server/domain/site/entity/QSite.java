...
public class QSite extends EntityPathBase<Site> {
    ...
    public final com.lineinc.erp.api.server.domain.clientcompany.entity.QClientCompany clientCompany;
    ...
    public QSite(Class<? extends Site> type, PathMetadata metadata, PathInits inits) {
        ...
        this.clientCompany = inits.isInitialized("clientCompany") ? new com.lineinc.erp.api.server.domain.clientcompany.entity.QClientCompany(forProperty("clientCompany"), inits.get("clientCompany")) : null;
