...
/**
 * QManagementCostMealFeeDetailOutsourcing is a Querydsl query type for ManagementCostMealFeeDetailOutsourcing
 */
@Generated("com.querydsl.codegen.DefaultEntitySerializer")
public class QManagementCostMealFeeDetailOutsourcing extends EntityPathBase<ManagementCostMealFeeDetailOutsourcing> {

    private static final long serialVersionUID = 197682654L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QManagementCostMealFeeDetailOutsourcing managementCostMealFeeDetailOutsourcing = new QManagementCostMealFeeDetailOutsourcing("managementCostMealFeeDetailOutsourcing");
    ...
    public QManagementCostMealFeeDetailOutsourcing(String variable) {
        this(ManagementCostMealFeeDetailOutsourcing.class, forVariable(variable), INITS);
    }

    public QManagementCostMealFeeDetailOutsourcing(Path<? extends ManagementCostMealFeeDetailOutsourcing> path) {
        this(path.getType(), path.getMetadata(), PathInits.getFor(path.getMetadata(), INITS));
    }

    public QManagementCostMealFeeDetailOutsourcing(PathMetadata metadata) {
        this(metadata, PathInits.getFor(metadata, INITS));
    }

    public QManagementCostMealFeeDetailOutsourcing(PathMetadata metadata, PathInits inits) {
        this(ManagementCostMealFeeDetailOutsourcing.class, metadata, inits);
    }

    public QManagementCostMealFeeDetailOutsourcing(Class<? extends ManagementCostMealFeeDetailOutsourcing> type, PathMetadata metadata, PathInits inits) {
