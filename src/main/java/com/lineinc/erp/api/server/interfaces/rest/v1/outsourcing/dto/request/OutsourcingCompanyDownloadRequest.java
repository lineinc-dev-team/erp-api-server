...
public record OutsourcingCompanyDownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS = "id,name,businessNumber,type,ceoName,address,phoneNumber,landlineNumber,contactName,contactPositionAndDepartment,defaultDeductions,isActive,createdAtAndUpdatedAt,hasFile,memo,email";
