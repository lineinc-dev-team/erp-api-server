...
public record SteelManagementResponse(
        ...
        @Schema(description = "이전 강재 수불 유형", example = "PURCHASE") String previousType,
        @Schema(description = "이전 강재 수불 유형 코드", example = "PURCHASE") String previousTypeCode,
    ...
    public static SteelManagementResponse from(final SteelManagement entity) {
        ...
        return new SteelManagementResponse(
                ...
                entity.getPreviousType() != null ? entity.getPreviousType().getLabel() : null,
                entity.getPreviousType() != null ? entity.getPreviousType().name() : null,
                entity.getStartDate(),
                entity.getEndDate(),
                entity.getOrderDate(),
