...
public record ClientCompanyFileUpdateRequest(
        @Schema(description = "파일 ID", example = "1") @NotBlank Long id,
        @Schema(description = "문서명", example = "계약서_2024") @NotBlank String name,
        @Schema(description = "파일 접근용 URL", example = "https://s3.amazonaws.com/bucket/contract_2024.pdf") @NotBlank String fileUrl,
        @Schema(description = "원본 파일명", example = "contract_2024.pdf") @NotBlank String originalFileName,
        @Schema(description = "파일 타입", example = "BUSINESS_LICENSE") @NotBlank ClientCompanyFileType type,
