...
public record MaterialManagementFileResponse(
        ...
        @Schema(description = "파일 URL (S3 또는 외부 저장소)", example = "https://bucket.s3.amazonaws.com/파일경로/견적서.pdf") String fileUrl,
        @Schema(description = "원본 파일명", example = "quotation_original.pdf") String originalFileName,
        @Schema(description = "파일에 대한 비고 또는 설명", example = "첫 납품 관련 견적서 파일") String memo) {
    public static MaterialManagementFileResponse from(final MaterialManagementFile entity) {
