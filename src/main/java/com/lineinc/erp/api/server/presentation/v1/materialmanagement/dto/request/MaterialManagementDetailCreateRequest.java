...
public record MaterialManagementDetailCreateRequest(
        ...
        @Schema(description = "규격", example = "10mm")
        String standard,

        @Schema(description = "사용용도", example = "기초 보강")
        String usage,
        ...
        @Schema(description = "공급가", example = "120000")
        Integer supplyPrice,

        @Schema(description = "부가세", example = "12000")
        Integer vat,

        @Schema(description = "합계", example = "132000")
        Integer total,

        @Schema(description = "비고", example = "1차 납품분")
        String memo
) {
}
