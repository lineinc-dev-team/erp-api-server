...
public record DailyReportCreateRequest(
        ...
        @Schema(description = "직영/용역 용역 출역 정보") @Valid List<DailyReportDirectContractOutsourcingCreateRequest> directContractOutsourcings,
        ...
        @Schema(description = "작업내용 정보") @Valid List<DailyReportWorkCreateRequest> works,
