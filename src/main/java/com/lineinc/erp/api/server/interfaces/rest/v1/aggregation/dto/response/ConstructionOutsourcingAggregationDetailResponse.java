...
public record ConstructionOutsourcingAggregationDetailResponse(
    ...
    public record ConstructionGroupItem(@Schema(
            description = "외주업체계약 공사항목 그룹 정보") ContractConstructionGroupSimpleResponseForDailyReport outsourcingCompanyContractConstructionGroup,
    ...
    public record ConstructionItem(@Schema(description = "공사항목 ID", example = "1") Long id,
            ...
            @Schema(description = "외주계약금액 수량",
                    example = "100.5") Double outsourcingContractQuantity,
    ...
    public record BillingDetail(
            @Schema(description = "총 수량", example = "100.5") Double totalQuantity,
