 ...
 * 현장관리비 상세 응답
 */
@Schema(description = "현장관리비 상세 응답")
public record SiteManagementCostDetailResponse(
    ...
    public static SiteManagementCostDetailResponse from(final SiteManagementCost entity) {
        return new SiteManagementCostDetailResponse(
                entity.getId(),
                entity.getYearMonth(),
