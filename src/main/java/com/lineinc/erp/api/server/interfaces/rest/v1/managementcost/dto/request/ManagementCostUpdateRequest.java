...
public record ManagementCostUpdateRequest(
        ...
        @Schema(description = "관리비 품목 구분", example = "DEPOSIT") ItemType itemType,

        @Schema(description = "관리비 품목 설명", example = "6월 전기요금") String itemTypeDescription,
        ...
        @Schema(description = "대표자 이름", example = "홍길동") String ceoName,

        @Schema(description = "계좌번호", example = "1002-123-456789") String accountNumber,

        @Schema(description = "예금주", example = "홍길동") String accountHolder,

        @Schema(description = "은행명", example = "기업은행") String bankName,
