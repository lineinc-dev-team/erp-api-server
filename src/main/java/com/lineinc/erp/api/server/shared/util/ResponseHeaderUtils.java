...
public class ResponseHeaderUtils {
     ...
     */
    public static void setExcelDownloadHeader(final HttpServletResponse response, final String filename) {
        ...
        try {
            ...
            final String contentDisposition = "attachment; filename*=UTF-8''" + encodedFilename;
