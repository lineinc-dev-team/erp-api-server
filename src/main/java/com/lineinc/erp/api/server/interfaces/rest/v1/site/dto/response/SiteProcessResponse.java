...
public record SiteProcessResponse(
        @Schema(description = "공정 ID", example = "1") Long id,

        @Schema(description = "공정명", example = "기초 공사") String name,

        @Schema(description = "사무실 전화번호") String officePhone,

        @Schema(description = "공정 상태", example = "준비중") String status,

        @Schema(description = "공정 상태 코드", example = "IN_PROGRESS") SiteProcessStatus statusCode,

        @Schema(description = "공정 비고", example = "공정 진행 중") String memo) {
