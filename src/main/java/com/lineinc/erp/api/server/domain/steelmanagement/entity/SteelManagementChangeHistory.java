...
@AllArgsConstructor
@SuperBuilder
public class SteelManagementChangeHistory extends BaseEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "steel_management_change_history_seq")
    @SequenceGenerator(name = "steel_management_change_history_seq", sequenceName = "steel_management_change_history_seq", allocationSize = 1)
    private Long id;
