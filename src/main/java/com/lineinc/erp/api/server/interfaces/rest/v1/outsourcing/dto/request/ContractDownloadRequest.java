...
public record ContractDownloadRequest(
        @NotEmpty @Schema(description = "허용 필드: id, siteName, processName, companyName, businessNumber, contractType, contractPeriod, contractAmount, defaultDeductions, taxInvoiceCondition, contactName, createdAt, contractStatus, memo", example = "id,siteName,processName") String fields) {
    ...
    public static final List<String> ALLOWED_FIELDS = List.of(
            ...
            "contactName", "createdAt", "contractStatus", "memo");
}
