...
public record SteelManagementDetailV2Response(
        ...
        @Schema(description = "타입", example = "INCOMING") SteelManagementDetailV2Type type,
        @Schema(description = "타입명", example = "입고") String typeName,
        @Schema(description = "품명", example = "철근") String name,
        @Schema(description = "규격", example = "D10") String specification,
        @Schema(description = "무게 (kg)", example = "5.6") Double weight,
