 ...
 * 노무인력 명세서 이력 응답 DTO
 */
@Schema(description = "노무인력 명세서 이력 응답")
public record LaborPayrollHistoryResponse(
        @Schema(description = "ID") Long id,

        // 기본 정보
        @Schema(description = "연월 (YYYY-MM)") String yearMonth,
     ...
     */
    public static LaborPayrollHistoryResponse from(LaborPayroll laborPayroll) {
        return new LaborPayrollHistoryResponse(
                laborPayroll.getId(),
