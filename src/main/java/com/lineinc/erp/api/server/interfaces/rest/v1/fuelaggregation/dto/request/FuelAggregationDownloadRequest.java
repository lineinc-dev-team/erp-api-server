...
public record FuelAggregationDownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS = "id,siteName,processName,date,outsourcingCompanyName,driverName,vehicleNumber,specification,fuelType,fuelAmount,amount,createdAtAndUpdatedAt,memom,fuelOutsourcingCompanyName";
