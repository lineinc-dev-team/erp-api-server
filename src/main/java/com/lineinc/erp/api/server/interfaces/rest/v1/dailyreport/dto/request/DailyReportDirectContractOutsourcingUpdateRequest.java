...
@Schema(description = "출역일보 직영/용역 용역 수정 요청")
public record DailyReportDirectContractOutsourcingUpdateRequest(
        @Schema(description = "수정할 직영/용역 용역 정보 목록") List<@Valid DirectContractOutsourcingUpdateInfo> directContractOutsourcings) {

    @Schema(description = "직영/용역 용역 정보 수정 내용")
