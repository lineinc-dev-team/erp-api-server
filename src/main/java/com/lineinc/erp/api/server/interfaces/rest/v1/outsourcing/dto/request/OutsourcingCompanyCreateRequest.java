...
public record OutsourcingCompanyCreateRequest(@Schema(description = "외주업체명", example = "삼성 ENG") @NotBlank String name,
        ...
        @Schema(description = "기본 공제 항목 (콤마로 구분된 문자열)", example = "FUEL_COST,FOUR_INSURANCES") String defaultDeductions,
        ...
        @Schema(description = "부가세 적용 타입", example = "VAT_INCLUDED") OutsourcingCompanyVatType vatType,
        @Valid @Schema(description = "담당자 목록") List<OutsourcingCompanyContactCreateRequest> contacts,
