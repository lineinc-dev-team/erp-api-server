...
public record ManagementCostFileResponse(
        ...
        @Schema(description = "문서명", example = "6월 관리비 증빙서류")
        String name,

        @Schema(description = "파일 URL", example = "https://s3.amazonaws.com/.../file.pdf")
        String fileUrl,

        @Schema(description = "원본 파일명", example = "invoice_june.pdf")
        String originalFileName,

        @Schema(description = "비고", example = "세금계산서 첨부")
        String memo
) {
