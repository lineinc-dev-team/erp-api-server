...
public record SiteFileResponse(
        ...
        @Schema(description = "파일 이름", example = "사업계획서")
        String name,

        @Schema(description = "파일 URL", example = "https://s3.amazonaws.com/your-bucket/file.pdf")
        String fileUrl,

        @Schema(description = "원본 파일명", example = "plan.pdf")
        String originalFileName,

        @Schema(description = "파일 메모", example = "최종 제출본")
        String memo,
