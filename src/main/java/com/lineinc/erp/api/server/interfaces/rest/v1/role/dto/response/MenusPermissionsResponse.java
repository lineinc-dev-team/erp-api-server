...
public record MenusPermissionsResponse(
        ...
        @Schema(description = "메뉴 이름", example = "전체권한") String name,

        @Schema(description = "권한") List<PermissionDto> permissions) {
    ...
    public record PermissionDto(
            @Schema(description = "권한 ID", example = "1") Long id,
            @Schema(description = "권한 이름", example = "조회") String action) {
