...
public record OutsourcingCompanyContractUpdateRequest(
        ...
        @Schema(description = "계약 담당자 목록") List<OutsourcingCompanyContractContactUpdateRequest> contacts,

        @Schema(description = "계약 첨부파일 목록") List<OutsourcingCompanyContractFileUpdateRequest> files,

        @Schema(description = "계약 인력 목록") List<OutsourcingCompanyContractWorkerUpdateRequest> workers,

        @Schema(description = "계약 장비 목록") List<OutsourcingCompanyContractEquipmentUpdateRequest> equipments,
