...
public record CompanyDetailResponse(
        ...
        @Schema(description = "구분", example = "장비") String type,
        @Schema(description = "구분", example = "EQUIPMENT") OutsourcingCompanyType typeCode,
        @Schema(description = "구분 설명", example = "도급업체") String typeDescription,
