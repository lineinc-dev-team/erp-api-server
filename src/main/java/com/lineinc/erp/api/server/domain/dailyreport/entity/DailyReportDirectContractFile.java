...
public class DailyReportDirectContractFile extends BaseEntity {

    private static final String SEQUENCE_NAME = "daily_report_direct_contract_file_seq";
    ...
    /**
     * 이 사진이 연결된 출역일보 직영/계약직 엔티티
     */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "daily_report_employee_id", nullable = false)
    @DiffIgnore
    private DailyReportDirectContract dailyReportDirectContract;
