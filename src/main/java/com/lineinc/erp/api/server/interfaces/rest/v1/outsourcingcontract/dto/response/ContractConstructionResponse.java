...
public record ContractConstructionResponse(@Schema(description = "공사항목 ID", example = "1") Long id,
        ...
        @Schema(description = "도급금액 수량", example = "100.5") Double contractQuantity,
        @Schema(description = "도급금액 금액", example = "5000000") Long contractPrice,
        @Schema(description = "외주계약금액 수량", example = "100.5") Double outsourcingContractQuantity,
    ...
    public static ContractConstructionResponse from(
            final OutsourcingCompanyContractConstruction construction) {
        return new ContractConstructionResponse(construction.getId(), construction.getItem(),
                construction.getSpecification(), construction.getUnit(),
                construction.getUnitPrice(), construction.getContractQuantity(),
                construction.getContractPrice(), construction.getOutsourcingContractQuantity(),
                construction.getOutsourcingContractUnitPrice(),
                construction.getOutsourcingContractPrice(), construction.getMemo(),
                construction.isDeleted(), construction.getCreatedAt(), construction.getUpdatedAt());
    }
    ...
    public record ContractConstructionSimpleResponse(
        ...
        public static ContractConstructionSimpleResponse from(
                final OutsourcingCompanyContractConstruction construction) {
            return new ContractConstructionSimpleResponse(construction.getId(),
                    construction.getItem(), construction.getSpecification(), construction.getUnit(),
