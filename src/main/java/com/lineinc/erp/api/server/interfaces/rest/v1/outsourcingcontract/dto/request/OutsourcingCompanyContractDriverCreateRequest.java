...
public record OutsourcingCompanyContractDriverCreateRequest(
        @Schema(description = "운전자명", example = "김운전") @NotBlank String name,

        @Schema(description = "비고", example = "경력 15년") String memo,

        @Schema(description = "드라이버 서류 파일 목록") @Valid List<OutsourcingCompanyContractDriverFileCreateRequest> files) {
}
