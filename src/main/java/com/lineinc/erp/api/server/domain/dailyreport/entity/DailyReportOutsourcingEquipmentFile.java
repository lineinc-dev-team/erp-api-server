...
public class DailyReportOutsourcingEquipmentFile extends BaseEntity {

    private static final String SEQUENCE_NAME = "daily_report_outsourcing_equipment_file_seq";
    ...
    /**
     * 이 사진이 연결된 출역일보 외주업체 장비 엔티티
     */
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "daily_report_outsourcing_equipment_id", nullable = false)
    @DiffIgnore
    private DailyReportOutsourcingEquipment dailyReportOutsourcingEquipment;
