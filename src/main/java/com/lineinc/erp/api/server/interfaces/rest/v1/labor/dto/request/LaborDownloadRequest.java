...
public record LaborDownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS = "id,type,name,residentNumber,outsourcingCompanyName,workType,mainWork,phoneNumber,dailyWage,accountNumber,hireDate,resignationDate,tenureMonths,isSeverancePayEligible,hasBankbook,hasIdCard,hasSignatureImage,hasFile,hasLaborContract";
