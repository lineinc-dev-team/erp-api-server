...
public record MaterialManagementResponse(@Schema(description = "자재관리 ID", example = "1") Long id,
        ...
        @Schema(description = "요청일자", example = "2025-07-28") OffsetDateTime deliveryDate,
        @Schema(description = "첨부파일 존재 여부", example = "true") Boolean hasFile,
        @Schema(description = "비고", example = "1차 납품 완료") String memo,
        @Schema(description = "생성일",
                example = "2025-01-15T10:30:00+09:00") OffsetDateTime createdAt,
        @Schema(description = "수정일",
                example = "2025-01-16T14:20:00+09:00") OffsetDateTime updatedAt,
    ...
    public static MaterialManagementResponse from(final MaterialManagement entity,
        ...
        return new MaterialManagementResponse(entity.getId(),
                ...
                entity.getFiles() != null && entity.getFiles().stream().anyMatch(
                        file -> file.getFileUrl() != null && !file.getFileUrl().trim().isEmpty()),
                ...
                entity.getDeductionCompanyContract() != null
                        ? ContractListResponse.ContractSimpleResponse
                                .from(entity.getDeductionCompanyContract())
                        : null,
