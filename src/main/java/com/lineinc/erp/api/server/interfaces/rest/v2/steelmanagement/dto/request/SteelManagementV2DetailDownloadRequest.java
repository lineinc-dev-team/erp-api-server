...
public record SteelManagementV2DetailDownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS = "name,specification,weight,count,totalWeight,unitPrice,amount,vat,total,category,outsourcingCompanyName,incomingDate,outgoingDate,salesDate,createdAt,originalFileName,memo";
