...
public record SteelManagementV2DetailDownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS =
            "incomingDate,outgoingDate,salesDate,name,specification,weight,count,totalWeight,unitPrice,amount,vat,total,category,outsourcingCompanyName,createdAt,originalFileName,memo,length";
