...
public record OutsourcingCompanyUpdateRequest(
        @Schema(description = "외주업체명", example = "삼성ENG") String name,
        ...
        @Schema(description = "담당자 목록") List<OutsourcingCompanyContactUpdateRequest> contacts,

        @Schema(description = "첨부파일 목록") List<OutsourcingCompanyFileUpdateRequest> files,

        @Schema(description = "수정 이력 리스트") List<OutsourcingCompanyUpdateRequest.ChangeHistoryRequest> changeHistories) {
