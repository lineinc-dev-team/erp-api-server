...
public record SteelManagementV2DownloadRequest(
    ...
    private static final String EXAMPLE_FIELDS = "id,siteName,processName,incomingOwnMaterial,incomingPurchase,incomingRental,outgoingOwnMaterial,outgoingPurchase,outgoingRental,onSiteStock,scrap,totalInvestmentAmount,onSiteRemainingAmount,createdAt";
