...
public record MaterialManagementDetailViewResponse(
    ...
    public static MaterialManagementDetailViewResponse from(final MaterialManagement entity) {
        return new MaterialManagementDetailViewResponse(entity.getId(),
                ...
                entity.getMemo(), SiteResponse.SiteSimpleResponse.from(entity.getSite()),
                ...
                entity.getDeductionCompanyContract() != null
                        ...
                        : null,
                entity.getDetails().stream().map(MaterialManagementDetailResponse::from)
                        .sorted(Comparator.comparing(MaterialManagementDetailResponse::id))
                        .toList(),
                entity.getFiles().stream().map(MaterialManagementFileResponse::from)
                        .sorted(Comparator.comparing(MaterialManagementFileResponse::id)).toList());
    }
}
