package com.lineinc.erp.api.server.interfaces.rest.v2.labormanagement.controller;
...
@RestController
@RequestMapping("/api/v2/labors")
@RequiredArgsConstructor
@Tag(name = "노무 관리 V2", description = "노무 관련 V2 API")
public class LaborV2Controller {
    ...
    public ResponseEntity<SuccessResponse<PagingResponse<LaborChangeHistoryResponse>>> getLaborChangeHistoriesWithCount(
            @PathVariable Long id,
            @Valid PageRequest pageRequest,
            @Valid SortRequest sortRequest) {
        Page<LaborChangeHistoryResponse> page = laborService.getLaborChangeHistoriesWithPaging(id,
