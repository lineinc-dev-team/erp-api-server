...
public record ClientCompanyContactCreateRequest(
        @NotBlank @Schema(description = "담당자명", example = "홍길동") String name,
        @NotBlank @Schema(description = "직급", example = "팀장") String position,
        @NotBlank @Schema(description = "부서", example = "영업팀") String department,
        @NotNull @Schema(description = "대표 담당자 여부", example = "true") Boolean isMain,
        ...
        @NotBlank @Email @Schema(description = "담당자 이메일", example = "hong@example.com") String email,
