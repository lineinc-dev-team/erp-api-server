...
public record OutsourcingCompanyContractDriverUpdateRequest(
        @Schema(description = "운전자 ID", example = "1") @NotNull Long id,

        @Schema(description = "운전자명", example = "김운전") @NotNull String name,

        @Schema(description = "비고", example = "경력 15년") String memo,

        @Schema(description = "드라이버 서류 파일 목록") @Valid List<OutsourcingCompanyContractDriverFileUpdateRequest> files) {
}
