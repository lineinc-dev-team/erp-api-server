...
import com.lineinc.erp.api.server.domain.labor.service.v2.LaborV2Service;
...
@Tag(name = "노무 관리 V2")
public class LaborV2Controller extends BaseController {

    private final LaborV2Service laborV2Service;

    @Operation(summary = "노무 변경 이력 조회")
