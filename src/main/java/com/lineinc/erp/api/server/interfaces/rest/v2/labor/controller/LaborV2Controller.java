package com.lineinc.erp.api.server.interfaces.rest.v2.labor.controller;
...
public class LaborV2Controller {
    ...
    public ResponseEntity<SuccessResponse<PagingResponse<LaborChangeHistoryResponse>>> getLaborChangeHistoriesWithCount(
        ...
        final Page<LaborChangeHistoryResponse> page = laborService.getLaborChangeHistoriesWithPaging(id,
